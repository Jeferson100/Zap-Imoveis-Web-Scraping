...
tipo_async = os.getenv("TIPO_ASYNC")
...
MAPA_BAIRROS = {
    'vila chartres': ['nucleo urbano isolado residencial duquesa de chartres'],
    'rural' : ['area rural de jaragua do sul'],
    'rio cerro': ['garibaldi', 'rio cerro i', 'rio cerro ii', 'parque malwee',],
    'ribeirao grande do norte': ['ribeirao grande'],
    'rio molha': ['rio molha', 'barra do rio molha',  'molha'],
    'ribeirao cavalo' : ['braco do ribeirao cavalo', 'ribeirao cavalo', 'ribeirao do cavalo', 'cavalo'],
    'jaragua 99' : ['jaragua noventa e nove', ]
