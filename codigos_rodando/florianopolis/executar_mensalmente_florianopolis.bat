@echo off
title Maratona de Dados Florianópolis - Ciencia de Dados
cls

echo ======================================================
echo   INICIANDO COLETA MENSAL DE IMOVEIS - FLORIANÓPOLIS
echo ======================================================
echo.

:: 1. Entra na pasta do projeto
cd /d "C:\Users\jefer\Documents\Ciencia-de-dados\Preco-Imoveis\codigos_rodando\florianopolis"
...
uv run rodando_florianopolis.py

:: 4. Sincronizacao com o GitHub
echo.
echo [INFO] Sincronizando resultados com o GitHub...
git add .
git commit -m "Update mensal Florianópolis: %date%"
