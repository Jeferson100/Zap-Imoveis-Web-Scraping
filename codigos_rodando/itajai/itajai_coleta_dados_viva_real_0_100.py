...
URL_TEMPLATE = "https://www.vivareal.com.br/venda/santa-catarina/itajai/?onde=%2CSanta+Catarina%2CItaja%C3%AD%2C%2C%2C%2C%2Ccity%2CBR%3ESanta+Catarina%3ENULL%3EItajai%2C-26.908278%2C-48.677511%2C&pagina={pagina}"

sys.path.append('..')
    
now = time.strftime("%Y-%m")

area_ranges = {'0': '65','66': '80','81': '100'
               #'111': '170','171': '350','351': '3000000'
               }
