...
MAPA_BAIRROS = {
    ...
    'itaipava' : ['area rural de itajai'],
    'praia brava' : ['praia brava de itajai', 'balneario santa clara'],
    'arraia dos cunhas' : ['quilometro 12', 'quilometro doze'],
    'imarui' : ['marui'],
    'sao vicente' : ['nilo bittencourt'],
    'brilhante ii' : ['brilhante'],
