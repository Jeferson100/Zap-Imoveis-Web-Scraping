...
URL_TEMPLATE = "https://www.chavesnamao.com.br/imoveis-a-venda/sc-itajai/?filtro=amin%3A{min}%2Camax%3A{max}&pg={pagina}"

now = time.strftime("%Y-%m")

total_paginas = 100

area_ranges = { #'0': '50','51': '65','66': '75','76': '85',
               #'86': '100','101': '120','121': '150',
               '171': '190','191' : '270','271': '400','401': '600','601': '1600','1601': '300000000',
               }
