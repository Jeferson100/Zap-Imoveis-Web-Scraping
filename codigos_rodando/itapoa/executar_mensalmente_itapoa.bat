@echo off
title Maratona de Dados Itapoa - Ciencia de Dados
cls

echo ======================================================
echo   INICIANDO COLETA MENSAL DE IMOVEIS - ITAPOA
echo ======================================================
echo.

:: 1. Entra na pasta do projeto
cd /d "C:\Users\jefer\Documents\Ciencia-de-dados\Preco-Imoveis\codigos_rodando\itapoa"
