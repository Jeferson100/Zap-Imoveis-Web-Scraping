...
logger.info(f"Iniciando limpeza de dados de aluguel de imóveis de {cidade}...")

logger.info(f"Pasta de dados: {PASTA_DADOS}")

PASTA_DADOS.mkdir(parents=True, exist_ok=True)

logger.info(f"Os parametros de limpeza são: cidade_limpeza={cidade_limpeza}, cidade_localizacao={cidade_localizacao}, estado_limpeza={estado_limpeza}, estado_localizacao={estado_localizacao}, BATCH={BATCH}")
...
limpando_dados(name_arquivo_zap = f'{cidade}_aluguel_zap_*.parquet', 
               name_arquivo_vivareal = f'{cidade}_aluguel_vivareal_*.parquet', 
               name_arquivo_chave_mao = f'{cidade}_aluguel_chave_mao_*.parquet',
               name_arquivo_olx = f'{cidade}_aluguel_olx_*.json',
               name_arquivo_saida = f'{cidade}_aluguel_imoveis_limpo', 
