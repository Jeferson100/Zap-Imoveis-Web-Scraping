...
URL_TEMPLATE = "https://www.olx.com.br/imoveis/venda/estado-sc/norte-de-santa-catarina/balneario-camboriu?ss=0&se=95&o={pagina}"
...
output_file   = PASTA_DADOS / f'{cidade}_olx_{now}_0_95.json' 
