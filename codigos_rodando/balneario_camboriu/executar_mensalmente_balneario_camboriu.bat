@echo off
title Maratona de Dados Balneario Camboriu - Ciencia de Dados
cls

echo ======================================================
echo   INICIANDO COLETA MENSAL DE IMOVEIS - BALNEARIO CAMBORIU
echo ======================================================
echo.

:: 1. Entra na pasta do projeto
cd /d "C:\Users\jefer\Documents\Ciencia-de-dados\Preco-Imoveis\codigos_rodando\balneario_camboriu"
...
uv run rodando_balneario_camboriu.py

:: 4. Sincronizacao com o GitHub
echo.
#echo [INFO] Sincronizando resultados com o GitHub...
#git add .
#git commit -m "Update mensal Balneario Camboriu: %date%"
