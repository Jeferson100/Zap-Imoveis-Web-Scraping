...
URL_TEMPLATE = "https://www.chavesnamao.com.br/imoveis-para-alugar/sc-balneario-camboriu/?filtro=amin%3A{min}%2Camax%3A{max}&pg={pagina}"
...
area_ranges = {'0': '50', '51': '100', '101': '3000000'}

headless = os.getenv("HEADLESS", "True").lower() == "true"

max_concurrency = int(os.getenv("MAX_CONCURRENCY_CHAVE", "5"))

for min_area, max_area in area_ranges.items():
    
    logger.info(f"Coletando dados de {min_area} a {max_area}")
    
    output_file   = PASTA_DADOS / f'{cidade}_aluguel_chave_mao_{now}_{min_area}_{max_area}.parquet'
