...
URL_TEMPLATE = "https://www.olx.com.br/imoveis/venda/estado-sc/norte-de-santa-catarina/balneario-camboriu?ss=241&se=170000000&o={pagina}"
sys.path.append('..')
...
output_file   = PASTA_DADOS / f'{cidade}_olx_{now}_241_infinito.json' 
