...
URL_TEMPLATE = "https://www.vivareal.com.br/venda/santa-catarina/balneario-camboriu/?onde=%2CSanta+Catarina%2CBalne%C3%A1rio+Cambori%C3%BA%2C%2C%2C%2C%2Ccity%2CBR%3ESanta+Catarina%3ENULL%3EBalneario+Camboriu%2C-26.997984%2C-48.63258%2C&pagina={pagina}"

sys.path.append('..')
    
now = time.strftime("%Y-%m")

area_ranges = {#'0': '50','51': '60','61': '70','71': '80','81': '90','91': '100','101': '120',
               #'121': '140','141': '160','161': '180',
               #'181': '200','201': '250',
               '241': '300','301': '400','401': '500','501': '600','601': '3000000',
