...
URL_TEMPLATE = "https://www.olx.com.br/imoveis/aluguel/estado-sc/norte-de-santa-catarina/balneario-camboriu?o={pagina}"
...
output_file   = PASTA_DADOS / f'{cidade}_aluguel_olx_{now}.json' 
