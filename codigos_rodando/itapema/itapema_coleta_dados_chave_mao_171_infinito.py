...
#URL_TEMPLATE = "https://www.chavesnamao.com.br/imoveis-a-venda/sc-itapema/?pg={pagina}"

URL_TEMPLATE = "https://www.chavesnamao.com.br/imoveis-a-venda/sc-itapema/?filtro=amin%3A{min}%2Camax%3A{max}&pg={pagina}"

now = time.strftime("%Y-%m")

total_paginas = 100

area_ranges = {#'0': '65','66': '70','71': '90','91': '110',
               #'111': '120','121': '130','131': '150','151': '170',
               '171': '180','181': '210','211': '3000000'
               }
