...
if train_path.exists() and test_path.exists():
    ...
    caminho_consolidado = PASTA_DADOS / f"{cidade}_imoveis_limpo_{MES_REF}.parquet"
    if caminho_consolidado.exists():
        ...
        if not arquivos:
            raise FileNotFoundError(f"Nenhum arquivo imoveis_limpo para {cidade} em {PASTA_DADOS}")
