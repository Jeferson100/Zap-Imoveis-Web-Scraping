...
class VivaRealDadosImovelAsync:
    ...
    async def _extrair_links_imagens(self, page: Page) -> List[str]:
        ...
        try:
            ...
            sources = page.locator('[data-testid="carousel-photos"] picture source[srcset*="resizedimgs"]')
...
if __name__ == "__main__":
    async def main():
        urls = ['https://www.vivareal.com.br/imovel/casa-2-quartos-jarivatuba-bairros-joinville-com-garagem-60m2-venda-RS349636-id-2879650023/',
        ...
        async def scrape(url: str) -> DadosImovel:
            async with VivaRealDadosImovelAsync(url, headless=True) as scraper:
